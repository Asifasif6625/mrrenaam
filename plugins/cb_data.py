...
async def rename(bot,update):
	...
	await update.message.delete()
	await update.message.reply_text("__ᴩʟᴢᴢ ꜱᴇɴᴅ ꜰɪʟᴇ ɴᴀᴍᴇ🥰__",	
...
async def doc(bot,update):
     ...
     ms = await update.message.edit("ᴛʀyɪɴɢ ᴛᴏ ᴜᴩʟᴏᴀᴅᴇ⚡️")
     c_time = time.time()
     try:
     ...
     await ms.edit("ᴛʀyɪɴɢ ᴛᴏ ᴜᴩʟᴏᴀᴅᴇ⚡️")
     c_time = time.time() 
     try:
        if type == "document":
           await bot.send_document(
		    update.message.chat.id,
                    ...
                    progress_args=( "ᴛʀyɪɴɢ ᴛᴏ ᴜᴩʟᴏᴀᴅᴇ⚡️",  ms, c_time   ))
        elif type == "video": 
